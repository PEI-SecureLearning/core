...
test('test', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Organization name*' }).fill('ua.pt');
    await page.getByRole('textbox', { name: 'Tenant domain/email pattern*' }).click();
    await page.getByRole('textbox', { name: 'Tenant domain/email pattern*' }).fill('u');
    await page.getByRole('textbox', { name: 'Organization name*' }).click();
    ...
    const heading = page.getByRole('heading', { name: 'ua' });
