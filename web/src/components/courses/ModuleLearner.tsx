...
export default function ModuleLearner({ module: mod, courseId }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col h-full overflow-hidden bg-surface-subtle">
      ...
      <div className="relative flex items-center justify-between px-6 py-4 bg-background border-b border-border shadow-sm shrink-0">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* ── Left sidebar ── */}
        <div className="w-64 shrink-0 bg-background border-r border-border flex flex-col overflow-hidden">
          {/* Module title + meta */}
          ...
          <div className="flex-1 overflow-y-auto py-2">
            ...
            {sections.length === 0 ? (
              <p className="px-4 py-3 text-xs text-muted-foreground/70 italic">
                No sections
              </p>
            ) : (
              sections.map((sec, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p
                        className={`text-xs font-semibold truncate transition-colors ${isLocked ? "text-muted-foreground/70" : "text-foreground/90 group-hover:text-primary"}`}
                      >
