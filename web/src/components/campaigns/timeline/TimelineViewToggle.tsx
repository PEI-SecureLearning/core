...
import type { ViewPeriod } from "./TimelineView"; // Importamos o tipo correto

interface TimelineViewToggleProps {
  activeView: ViewPeriod;
...
export const TimelineViewToggle = memo(function TimelineViewToggle({
  ...
  // Opções atualizadas para bater certo com a lógica do TimelineView
  const views: { value: ViewPeriod; label: string }[] = [
