...
const statusConfig: Record<CampaignStatus, { label: string; color: string; bg: string; icon: React.ElementType }> = {
    ...
    paused: { label: "Paused", color: "text-foreground/90", bg: "bg-muted", icon: Pause },
        ...
        <tr className="hover:bg-surface-subtle transition-colors">
            <td className="px-6 py-4">
                <a href={`/campaigns/${campaign.id}`} className="block">
                    <p className="font-medium text-foreground hover:text-primary">{campaign.name}</p>
            ...
            <td className="px-6 py-4">
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-medium text-foreground">{campaign.stats.sent}</span>
                </div>
            </td>
            <td className="px-6 py-4">
                <div className="flex items-center gap-2">
                    <span className="font-medium text-foreground">{campaign.stats.opened}</span>
            ...
            <td className="px-6 py-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-foreground">{campaign.stats.clicked}</span>
            ...
            <table className="w-full">
                <thead className="bg-surface-subtle border-b border-border">
                    <tr>
                        ...
                        <th className="text-left px-6 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Duration</th>
                        ...
                        <th className="text-left px-6 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Clicked</th>
