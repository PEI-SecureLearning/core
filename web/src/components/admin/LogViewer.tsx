...
import { Search, AlertCircle, Info, CheckCircle, Loader2 } from "lucide-react";
          ...
          {loading ? (
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-surface-subtle sticky top-0 z-10">
                <tr>
                  <th className="px-6 py-3 font-medium text-muted-foreground w-48">
                    Timestamp
                  </th>
                  <th className="px-6 py-3 font-medium text-muted-foreground w-24">
                    Level
                  </th>
                  <th className="px-6 py-3 font-medium text-muted-foreground">
                    Message
                  </th>
                  <th className="px-6 py-3 font-medium text-muted-foreground w-40">
                    Source
                  </th>
                  <th className="px-6 py-3 font-medium text-muted-foreground w-40">
                    User
