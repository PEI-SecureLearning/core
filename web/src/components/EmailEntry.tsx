    ...
    return (
        <div className="min-h-screen w-full bg-black text-white overflow-hidden relative flex flex-col items-center justify-center font-sans">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-background/10 border border-white/20 backdrop-blur-md mb-8">
                        <Sparkles className="w-4 h-4 text-yellow-400" />
                        <span className="text-sm font-medium text-muted-foreground/40">Welcome Back</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="relative group">
                        ...
                        <div className="relative flex items-center bg-background rounded-lg p-1">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent text-white placeholder-muted-foreground px-4 py-3 focus:outline-none"
                                required
                                disabled={loading}
                            />
                            <button
