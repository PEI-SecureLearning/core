            ...
            <div className="relative bg-surface rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden border border-border">
                ...
                <div className="grid grid-cols-3 gap-2 p-4 bg-surface-subtle border-t border-border">
                    ...
                    <button
                        ...
                        disabled={isSaving}
                        onClick={onDiscard}
                        className="w-full px-4 py-2 text-sm font-medium text-error bg-surface border border-border rounded-lg hover:bg-error/10 hover:border-error/20 transition-colors"
                    >
                        Discard
                    </button>
                    <button
                        ...
                        disabled={isSaving}
                        onClick={onSave}
                        className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary hover:bg-primary/80 transition-colors disabled:opacity-50 shadow-sm shadow-primary/20"
                    >
