...
class Settings(BaseSettings):
    ...
    # MongoDB
    MONGODB_URI: str = (
        "mongodb://template_user:template_pass@mongo:27017/securelearning?authSource=securelearning"
    )
    ...
    MONGODB_COLLECTION_SURVEYS: str = "surveys"
    ...
    def RABBITMQ_CONNECTION_PARAMS(self) -> pika.ConnectionParameters:
        ...
        return pika.ConnectionParameters(
            host=self.RABBITMQ_HOST, credentials=self.RABBIMQ_CREDS
        )
